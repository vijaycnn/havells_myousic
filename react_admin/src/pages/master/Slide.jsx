...
function Slide() {
                ...
                <>
                  <tr key={item.id}>
                    ...
                    <td className="col-fixed">
                      <Link
                        title="Edit"
                        to={`${adminAlias}/editSlide/${base64_encode(
  ...
  return (
    <>
      <h1 className="h4 mb-4 font-secondary fw-medium">CMS Context</h1>
      ...
      <div className="table-view bg-white rounded-4 p-4">
        <div className="mb-3 d-flex justify-content-between align-items-center">
          ...
          <div>
            <Link
              to={`${adminAlias}/addSlide`}
              className="btn btn-primary btn-sm"
            >
              <span className="nav-link-text">Add Context</span>
            </Link>
          </div>
        </div>
