...
function EditFaq() {
    ...
    const getFaq = async () => {
        setLoading(true);    setPreviousData(null);    
        await axiosInstance.get(`/faq/getById/${id}`)
          .then((response) => {
          // console.log('>>> ', response.data);
              setLoading(false);                    
              if (response.data.status === "success") {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        if(!hasError){            
            ...
            await axiosInstance.post(`/faq/update`, body)
              .then((response) => {
                    console.log('>>> ', response.data);
                setLoading(false)
                if (response.data.status === "success") {
            ...
            <Row>                            
              <Col md={4}>
                  <Form.Group className="mb-4">
                      ...
                      <Form.Select
                          name="categoryId" onChange={handleChange} value={data.categoryId} >
              ...
              <Col md={3}>
                  <Form.Group className="mb-4">
                      ...
                      <Form.Control type="text" name="orderNumber" value={data.orderNumber} placeholder="Order Number"
              ...
              <Col md={9}>
                  <Form.Group className="mb-4">
                      ...
                      <Form.Control as="textarea" name="quest" value={data.quest} placeholder="Question"
